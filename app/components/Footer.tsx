  ...
  return (
    <footer className="w-full bg-white border-t border-pink-100 pt-8 pb-24 sm:pb-20 mt-6">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pb-6 border-b border-pink-100">
          {/* Brand Col */}
          <div className="md:col-span-5 space-y-3">
            ...
            <div className="flex items-center gap-1.5 text-[11px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-200 w-fit">
          ...
          <div className="md:col-span-4 space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5 pt-0.5">
              {[
                ...
                <span
                  key={i}
                  className="px-2 py-0.5 bg-pink-50/60 border border-pink-100 rounded-md text-[10px] font-bold text-slate-600"
                >
                  {name}
                </span>
              ))}
        ...
        {/* Bottom copyright */}
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] font-medium text-slate-400">
